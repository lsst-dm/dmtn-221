...
$\begin{aligned} y_k(t \mid \omega, \theta)=& \theta_0+\sum_{n=1}^{M_{\text {base }}}\left[\theta_{2 n-1} \sin (n \omega t)+\theta_{2 n} \cos (n \omega t)\right] \\ & \theta_0^{(k)}+\sum_{n=1}^{M_{\text {band }}}\left[\theta_{2 n-1}^{(k)} \sin (n \omega t)+\theta_{2 n}^{(k)} \cos (n \omega t)\right] . \end{aligned}$
