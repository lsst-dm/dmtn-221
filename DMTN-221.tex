...
\section{Motivation}
The characterization of periodicity from time-series is a fundamental constraint to numerous astrophysical applications. Phenomenologically, estimating the periodicity and its significance can shed light on stellar pulsation theory \citet{Antonello:Antonello81}, distance estimation and mapping of the Galaxy through Cepeheids, Miras and RR Lyrae \citet{Skowron:Skowron2019}, constraint fundamental parameters of stellar binaries \citet{Farinella:Farinella1979, }, and stellar rotation \citet{Walkowicz: Walkowicz13}.



According to \citet{Richards:R13} highlights the importance of period for classification. 
